...
export class TodoItem extends HTMLElement {
  ...
  connectedCallback() {
    ...
    this.contentInput.addEventListener('blur', () => this.handleInputUpdate());
    this.contentInput.addEventListener('keydown', (e) => this.handelEnterPress(e));
  ...
  handleToggleChecked() {
    ...
    s.DeleteTodoItem(this.id, this.checkbox.checked);
    this.saveData();
  }
